...
/*   Updated: 2023/11/14 16:59:56 by mapoirie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_redir(t_ms *ms)
{
	...
	{
		if (tok_lst->type == T_DGREAT && tok_lst->next_token->type == T_GREAT &&
		tok_lst->next_token->next_token && tok_lst->next_token->next_token->type == T_EOF)// case : >>>eof 
		...
		(tok_lst->next_token->next_token->type && (tok_lst->next_token->next_token->type == T_DLESS || 
